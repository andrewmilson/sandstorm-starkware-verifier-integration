...
contract StarkParameters is PrimeFieldElement0 {
    uint256 internal constant N_COEFFICIENTS = 93;
    uint256 internal constant N_INTERACTION_ELEMENTS = 6;
    uint256 internal constant MASK_SIZE = 133;
    uint256 internal constant N_ROWS_IN_MASK = 72;
    uint256 internal constant N_COLUMNS_IN_MASK = 10;
    uint256 internal constant N_COLUMNS_IN_TRACE0 = 7;
    uint256 internal constant N_COLUMNS_IN_TRACE1 = 3;
    ...
    uint256 internal constant PUBLIC_MEMORY_STEP = 16;
    uint256 internal constant DILUTED_SPACING = 4;
    uint256 internal constant DILUTED_N_BITS = 16;
    uint256 internal constant PEDERSEN_BUILTIN_RATIO = 128;
    ...
    uint256 internal constant BITWISE__RATIO = 8;
    uint256 internal constant LAYOUT_CODE = 2110234636557836973669;
