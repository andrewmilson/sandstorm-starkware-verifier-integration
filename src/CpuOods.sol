    ...
    */
    fallback() external {
        ...
        assembly {
            ...
            := /*composition_query_responses*/ add(context, 0x7f40)
            ...
            for {
                ...
                mstore(
                    add(friQueue, 0x40),
                    /*friInvPoint*/ mload(add(denominatorsPtr, 0x920))
                )
    ...
    function oodsPrepareInverses(
        ...
        assembly {
            ...
            mstore(
                ...
                mulmod(
                    mload(add(expmodsAndPoints, 0x60)), // traceGenerator^9
                    mload(expmodsAndPoints), // traceGenerator^2
                    PRIME
                )
            )
            ...
            mstore(
                ...
                mulmod(
                    mload(add(expmodsAndPoints, 0x100)), // traceGenerator^28
                    mulmod(
                        mload(add(expmodsAndPoints, 0xc0)), // traceGenerator^13
                        mload(add(expmodsAndPoints, 0x40)), // traceGenerator^7
                        PRIME
            ...
            mstore(
                ...
                mulmod(
                    mload(add(expmodsAndPoints, 0x120)), // traceGenerator^48
                    mulmod(
                        mload(add(expmodsAndPoints, 0x120)), // traceGenerator^48
                        mulmod(
                            mload(add(expmodsAndPoints, 0x120)), // traceGenerator^48
            ...
            mstore(
                ...
                mulmod(
                    mload(add(expmodsAndPoints, 0x140)), // traceGenerator^216
                    mulmod(
                        mload(add(expmodsAndPoints, 0x100)), // traceGenerator^28
                        traceGenerator, // traceGenerator^1
                        PRIME
            ...
            mstore(
                ...
                mulmod(
                    mload(add(expmodsAndPoints, 0x160)), // traceGenerator^245
                    mulmod(
                        mload(add(expmodsAndPoints, 0x120)), // traceGenerator^48
                        mulmod(
                            mload(add(expmodsAndPoints, 0xe0)), // traceGenerator^14
            ...
            mstore(
                ...
                mulmod(
                    mload(add(expmodsAndPoints, 0x180)), // traceGenerator^320
                    mulmod(
                        mload(add(expmodsAndPoints, 0x180)), // traceGenerator^320
                        mulmod(
                            mload(add(expmodsAndPoints, 0x180)), // traceGenerator^320
            ...
            let oodsPoint := /*oods_point*/ mload(add(context, 0x2b40))
            {
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^9*/ mload(add(expmodsAndPoints, 0x60)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^14*/ mload(add(expmodsAndPoints, 0xe0)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^4*/ mload(add(expmodsAndPoints, 0x20)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^12*/ mload(add(expmodsAndPoints, 0xa0)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^11*/ mload(add(expmodsAndPoints, 0x80)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^28*/ mload(add(expmodsAndPoints, 0x100)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^48*/ mload(add(expmodsAndPoints, 0x120)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^320*/ mload(add(expmodsAndPoints, 0x180)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^245*/ mload(add(expmodsAndPoints, 0x160)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^216*/ mload(add(expmodsAndPoints, 0x140)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^13*/ mload(add(expmodsAndPoints, 0xc0)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^7*/ mload(add(expmodsAndPoints, 0x40)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^1010*/ mload(add(expmodsAndPoints, 0x1a0)),
                    PRIME
                )
            ...
            for {
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1c0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1e0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x200))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x220))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x280))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x2a0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x2c0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x300))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x320))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x340))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x360))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x380))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x3a0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x3c0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x3e0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x400))
                    )
