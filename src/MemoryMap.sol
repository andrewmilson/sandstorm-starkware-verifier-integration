...
contract MemoryMap {
    ...
    */
    ...
    uint256 internal constant MM_TRACE_LENGTH = 0x13f;
    uint256 internal constant MM_OFFSET_SIZE = 0x140;
    uint256 internal constant MM_HALF_OFFSET_SIZE = 0x141;
    uint256 internal constant MM_INITIAL_AP = 0x142;
    uint256 internal constant MM_INITIAL_PC = 0x143;
    uint256 internal constant MM_FINAL_AP = 0x144;
    uint256 internal constant MM_FINAL_PC = 0x145;
    uint256
    ...
    uint256
        ...
        0x148;
    uint256 internal constant MM_RC16__PERM__INTERACTION_ELM = 0x149;
    uint256 internal constant MM_RC16__PERM__PUBLIC_MEMORY_PROD = 0x14a;
    uint256 internal constant MM_RC_MIN = 0x14b;
    uint256 internal constant MM_RC_MAX = 0x14c;
    ...
    uint256
        ...
        0x14e;
    uint256 internal constant MM_DILUTED_CHECK__FIRST_ELM = 0x14f;
    uint256 internal constant MM_DILUTED_CHECK__INTERACTION_Z = 0x150;
    uint256 internal constant MM_DILUTED_CHECK__INTERACTION_ALPHA = 0x151;
    uint256 internal constant MM_DILUTED_CHECK__FINAL_CUM_VAL = 0x152;
    uint256 internal constant MM_PEDERSEN__SHIFT_POINT_X = 0x153;
    uint256 internal constant MM_PEDERSEN__SHIFT_POINT_Y = 0x154;
    uint256 internal constant MM_INITIAL_PEDERSEN_ADDR = 0x155;
    uint256 internal constant MM_INITIAL_RC_ADDR = 0x156;
    uint256 internal constant MM_INITIAL_BITWISE_ADDR = 0x157;
    uint256 internal constant MM_TRACE_GENERATOR = 0x158;
    uint256 internal constant MM_OODS_POINT = 0x159;
    uint256 internal constant MM_INTERACTION_ELEMENTS = 0x15a; // uint256[6]
    uint256 internal constant MM_COMPOSITION_ALPHA = 0x160;
    uint256 internal constant MM_OODS_VALUES = 0x161; // uint256[133]
    uint256 internal constant MM_CONSTRAINT_POLY_ARGS_END = 0x1e6;
    uint256 internal constant MM_COMPOSITION_OODS_VALUES = 0x1e6; // uint256[2]
    uint256 internal constant MM_OODS_EVAL_POINTS = 0x1e8; // uint256[48]
    uint256 internal constant MM_OODS_ALPHA = 0x218;
    uint256 internal constant MM_TRACE_QUERY_RESPONSES = 0x219; // uint256[480]
    uint256 internal constant MM_COMPOSITION_QUERY_RESPONSES = 0x3f9; // uint256[96]
    uint256 internal constant MM_LOG_N_STEPS = 0x459;
    uint256 internal constant MM_N_PUBLIC_MEM_ENTRIES = 0x45a;
    uint256 internal constant MM_N_PUBLIC_MEM_PAGES = 0x45b;
    uint256 internal constant MM_CONTEXT_SIZE = 0x45c;
}
